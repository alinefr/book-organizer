...
class MySettings( SimpleSettings ):
    ...
    def ENGINE( self ):
        from sqlalchemy import create_engine
        return create_engine( 'mysql://camelotlibrary:camelotlibrary@127.0.0.1/camelotlibrary' )   
...
my_settings = MySettings( 'Aline Freitas', 'Camelot Library' ) 
settings.append( my_settings )
# end custom settings

def start_application():
    from camelot.view.main import main
    from library.application_admin import MyApplicationAdmin
